...
const appendItems = async (dataArr, invArr, ID) => {
  ...
  dataArr.forEach(async (data) => {
    ...
    const total = await (0,_CountTotalItems_js__WEBPACK_IMPORTED_MODULE_4__.countTotalItem)(appCtn);
